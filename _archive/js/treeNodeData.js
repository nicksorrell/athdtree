...
[	
	...
	},
	{
		id: "2.2",
		type: "question",
		text: "Did the learner receive an Oracle error report?",
		choices: [
			choice1 = {
				text: "Yes",
				targetNode: "2.2.1"
	...
	//////SECTION B: Training (3.X)//////
	{
		id: "3.0",
		type: "question",
		text: "Do you have a question about what hte course is teaching or understanding a question in the course?",
		choices: [
			choice1 = {
				text: "Yes",
				targetNode: "3.1"
	...
	},
	{
		id: "4.8",
		type: "question",
		text: "What was the nature of the issue you encountered?",
		choices: [
			choice1 = {
				text: "A problem with multimedia",
				targetNode: "7.0"
			},
			choice2 = {
				text: "A problem with illegible or missing text",
				targetNode: "8.0"
			},
			choice3 = {
				text: "A problem with instructional content",
				targetNode: "9.0"
			},
			choice4 = {
